...
import 'package:emartdriver/ui/chat/PlayerWidget.dart';
                ...
                child: Row(
                  children: <Widget>[
                              ...
                              child: Row(
                                children: <Widget>[
                                  InkWell(
                                    ...
                                    child: Icon(
                                      Icons.mic,
                                      color: currentRecordingState == RecordingState.HIDDEN ? Colors.purple : Colors.red,
                                    ),
                                  ),
                                  Expanded(
                                    child: TextField(
                    ...
                    IconButton(
                        icon: Icon(
                          Icons.send,
                          color: _messageController.text.isEmpty ? Colors.purple.withOpacity(.5) : Colors.purple,
                        ),
                        onPressed: () async {
            ...
            children: <Widget>[
              ...
              Positioned.directional(
                  ...
                  child: Container(
                    ...
                    height: 8,
                    decoration: BoxDecoration(
                        color: homeConversationModel.members.firstWhere((element) => element.userID == messageData.senderID).isActive ? Colors.purple : Colors.grey,
              ...
              child: Padding(
                ...
                child: Stack(clipBehavior: Clip.hardEdge, alignment: Alignment.center, children: <Widget>[
                  Padding(
                    ...
                    child: PlayerWidget(
                      url: messageData.url.url,
                      color: isDarkMode(context) ? Color(COLOR_ACCENT) : Colors.purple,
                    ),
                  ),
                ]),
              ),
