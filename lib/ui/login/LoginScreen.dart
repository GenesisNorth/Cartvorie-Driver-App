        ...
        child: ListView(
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'Log In'.tr(),
                style: TextStyle(color: Colors.purple, fontSize: 25.0, fontWeight: FontWeight.bold),
              ),
            ),
                ...
                child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: Colors.purple, fontWeight: FontWeight.bold, fontSize: 17, letterSpacing: 1),
                      ),
                    ])),
              ),
            )
