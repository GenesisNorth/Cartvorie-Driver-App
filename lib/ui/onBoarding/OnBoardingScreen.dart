...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: isDarkMode(context) ? Color(0xff8e24aa) : null,
      body: Stack(
        children: <Widget>[
          PageView.builder(
            ...
            child: Align(
              ...
              child: SmoothPageIndicator(
                ...
                effect: ScrollingDotsEffect(
                    spacing: 20, activeDotColor: Colors.purple, dotColor: Colors.purple.withOpacity(0.4), dotWidth: 7, dotHeight: 7, fixedCenter: false),
              ),
            ),
          )),
          Visibility(
          ...
          Visibility(
              ...
              child: Positioned(
                  ...
                  child: InkWell(
                      ...
                      child: Text(
                        "SKIP".tr(),
                        style: TextStyle(fontSize: 19, color: Colors.purple, fontFamily: 'Poppinsm'),
                      )))),
          Visibility(
              visible: _currentIndex + 1 != _imageList.length,
              child: Positioned(
