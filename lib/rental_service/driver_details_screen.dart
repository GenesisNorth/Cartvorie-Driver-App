                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(color: Colors.purple, letterSpacing: 0.5, fontWeight: FontWeight.w900),
                            ),
                            Text(
                              "/day".tr(),
          ...
          Expanded(
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                elevation: 0,
                backgroundColor: tabString == "About" ? Colors.purple : Colors.grey.withOpacity(0.30),
              ),
            ),
          ),
          const SizedBox(
          ...
          Expanded(
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                shape: const StadiumBorder(),
                elevation: 0,
                backgroundColor: tabString == "Gallery" ? Colors.purple : Colors.grey.withOpacity(0.30),
              ),
            ),
          ),
          const SizedBox(
          ...
          Expanded(
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                shape: const StadiumBorder(),
                elevation: 0,
                backgroundColor: tabString == "Review" ? Colors.purple : Colors.grey.withOpacity(0.30),
              ),
            ),
          ),
        ],
                    ...
                    Row(
                      children: [
                        Icon(
                          Icons.ac_unit,
                          size: 20,
                          color: driverDetails!.carInfo!.airConditioning == "No" ? Colors.red : Colors.purple,
                        ),
                        const SizedBox(width: 5),
                        Text("Air Conditioner".tr(), style: TextStyle(letterSpacing: 1, color: driverDetails!.carInfo!.airConditioning == "No" ? Colors.red : Colors.purple))
                      ],
                    ),
                    const SizedBox(
                      height: 8,
